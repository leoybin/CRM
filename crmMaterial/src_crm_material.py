...
class ERPTOCrm():
    ...
    def proto_crm(self, app3, FData):
        ...
        materialId_lis = app3.select("select FNumber from RDS_CRM_SRC_MaterialDetail")
        material_lis = []
